...
#ifndef SAYONARA_PLAYER_SMARTPLAYLISTBYRELATIVEDATE_H
#define SAYONARA_PLAYER_SMARTPLAYLISTBYRELATIVEDATE_H

#include "SmartPlaylist.h"

class SmartPlaylistByRelativeDate :
	public SmartPlaylist
{
	public:
		static constexpr const auto ClassType = "relative-create-date";

		SmartPlaylistByRelativeDate(int id, int value1, int value2);
