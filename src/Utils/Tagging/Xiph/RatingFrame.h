...
#ifndef SAYONARA_XIPH_RATING_FRAME_H
#define SAYONARA_XIPH_RATING_FRAME_H
...
namespace Xiph
{
	...
	{
		public:
			RatingFrame(TagLib::Ogg::XiphComment* tag);
			~RatingFrame() override;
...
#endif // SAYONARA_XIPH_RATING_FRAME_H
