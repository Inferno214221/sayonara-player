...
bool SettingRegistry::init()
{
	...
	register_setting<Set::Lib_CoverShowArtist>("lib_cover_show_artist", true);
	...
	register_setting<Set::Engine_ConvertNumberThreads>("convert_number_threads", QThread::idealThreadCount());
	register_setting<Set::Engine_ConvertPreferredConverter>("convert_preferred_converter", "ogg");
	register_setting<Set::Engine_ConvertQualityLameVBR>( "convert_quality_lame_vbr", 7);
	register_setting<Set::Engine_ConvertQualityLameCBR>( "convert_quality_lame_cbr", 192);
	register_setting<Set::Engine_ConvertQualityOgg>("convert_quality_ogg", 7);
